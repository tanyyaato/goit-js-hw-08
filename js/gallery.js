...
container.addEventListener("click", openedModalWindow);

function openedModalWindow(event) {
  ...
  const choosenElement = images.find(
  ...
  const instance = basicLightbox.create(`
      ...
      src="${choosenElement.original}"
      
      alt="${choosenElement.description}"
    />
    <p class="text">${choosenElement.description}</p>
</div>
`);
  instance.show();
}
